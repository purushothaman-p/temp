...
const fname : &'static str = "hello.txt";
...
fn kobject_add(kobj: &kobject, parent: &kobject, fmt: &'static str, name: &'static str) -> i32{
    ...
    va_end(name);
    */
    return 0; // forcing it to zero and assuming key object is added successfully
}
...
fn main() {
    let ko = kobject { driver_id: 1, name: "KeyObject name".to_string()};
